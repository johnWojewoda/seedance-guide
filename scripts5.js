async function generateSection5() {
    ...
    const btn = document.getElementById('generate-btn-5');
    ...
    const prompt = document.getElementById('prompt-5').value.trim();
    if (!prompt) {
        status.style.color = '#ff4444';
    ...
    const duration = parseInt(document.getElementById('duration-5').value);
    const resolution = document.getElementById('resolution-5').value;
    const aspect_ratio = document.getElementById('aspect-5').value;
    const imageFile = document.getElementById('image5-upload').files[0];
...
document.getElementById('image5-upload').addEventListener('change', function() {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            const preview = document.getElementById('image-preview-5');
            const container = document.getElementById('image-preview-container-5');
