async function generateSection3() {
    ...
    const btn = document.getElementById('generate-btn-3');
    ...
    const prompt = document.getElementById('prompt-3').value.trim();
    if (!prompt) {
        status.style.color = '#ff4444';
    ...
    const duration = parseInt(document.getElementById('duration-3').value);
    const resolution = document.getElementById('resolution-3').value;
    const aspect_ratio = document.getElementById('aspect-3').value;
    const generate_audio = document.getElementById('audio-3').value === 'true';
    const imageFile = document.getElementById('image3-upload').files[0];
...
document.getElementById('image3-upload').addEventListener('change', function() {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            const container = document.getElementById('image-preview-container-3');
