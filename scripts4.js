async function generateSection4() {
    ...
    const btn = document.getElementById('generate-btn-4');
    ...
    const prompt = document.getElementById('prompt-4').value.trim();
    if (!prompt) {
        status.style.color = '#ff4444';
    ...
    const duration = parseInt(document.getElementById('duration-4').value);
    const resolution = document.getElementById('resolution-4').value;
    const aspect_ratio = document.getElementById('aspect-4').value;
    const imageFile = document.getElementById('image4-upload').files[0];
...
document.getElementById('image4-upload').addEventListener('change', function() {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            const container = document.getElementById('image-preview-container-4');
