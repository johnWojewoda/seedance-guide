async function generateSection6() {
    ...
    const btn = document.getElementById('generate-btn-6');
    ...
    const prompt = document.getElementById('prompt-6').value.trim();
    if (!prompt) {
        status.style.color = '#ff4444';
    ...
    const duration = parseInt(document.getElementById('duration-6').value);
    const resolution = document.getElementById('resolution-6').value;
    const aspect_ratio = document.getElementById('aspect-6').value;
    const generate_audio = document.getElementById('audio-6').value === 'true';
    const imageFile = document.getElementById('image6-upload').files[0];
...
document.getElementById('image6-upload').addEventListener('change', function() {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            const preview = document.getElementById('image-preview-6');
            const container = document.getElementById('image-preview-container-6');
